...
curl -v 'Content-Type':'application/sparql-update' -H "Accept: text/n3" -b cookies.txt --data-raw "PREFIX dc: <http://purl.org/dc/elements/1.1/> INSERT DATA { <http://example/book1> dc:title 'A new book' ; dc:creator 'A.N.Other' . }" -X PATCH $1
